    ...
    <br><br><br><br>
                                            ...
                                            for ($x = 0; $x < $result->num_rows; $x++) {
                                                ...
                                                for ($q = 0; $q < 3; $q++) {
                                                    ...
                                                    // Convert scheduled date and time to Asia/Manila timezone
                                                    $scheduledate = new DateTime($row["scheduledate"] . ' ' . $row["scheduletime"], new DateTimeZone('UTC'));
                                                    $scheduledate->setTimezone(new DateTimeZone('Asia/Manila'));

                                                    // Formatted date and time for display
                                                    $formattedDate = $scheduledate->format("M d, Y");
                                                    $formattedTime = $scheduledate->format("g:ia");
