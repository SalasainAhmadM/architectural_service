...
<body>
    ...
    <div class="container">
        ...
        <div class="dash-body">
            ...
            if ($_POST) {
                ...
                //echo $sqlpt2;
                //echo $sqlpt1;
                $sqlmain = "select schedule.scheduleid,schedule.title,schedule.cost,architect.archiname,schedule.scheduledate,schedule.scheduletime,schedule.nop from schedule inner join architect on schedule.archiid=architect.archiid ";
                ...
                $sqlmain = "select schedule.scheduleid,schedule.title,schedule.cost,architect.archiname,schedule.scheduledate,schedule.scheduletime,schedule.nop from schedule inner join architect on schedule.archiid=architect.archiid  order by schedule.scheduledate desc";
                                ...
                                <tbody>
                                    ...
                                    <br><br><br><br>
                                        ...
                                        ' . substr($archiname, 0, 20) . '
                                         ...
                                         <td style="text-align:center;">$' . number_format($cost * 0.3, 2) . '</td>
                                        <td style="text-align:center;">$' . number_format($cost * 0.7, 2) . '</td>
                                        ...
                                        <a href="?action=view&id=' . $scheduleid . '" class="non-style-link"><button  class="btn-primary-soft btn button-icon"  style="font-size: 11px;padding-left: 20px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text"><i style="margin-right: 4px"class="fa-regular fa-eye"></i>View</font></button></a>
                                       &nbsp;&nbsp;&nbsp;
                                       <a href="?action=drop&id=' . $scheduleid . '&name=' . $title . '" class="non-style-link"><button  class="btn-primary-soft btn button-icon"  style="font-size: 11px;padding-left: 20px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text"><i style="margin-right: 4px"class="fa-solid fa-xmark"></i>Remove</font></button></a>
                                        </div>
                                        </td>
                                    </tr>';
    ...
    if ($_GET) {
        ...
        if ($action == 'add-session') {
            ...
            $sqlmain = "select schedule.scheduleid,schedule.title,schedule.cost,architect.archiname,schedule.scheduledate,schedule.scheduletime,schedule.nop from schedule inner join architect on schedule.archiid=architect.archiid  where  schedule.scheduleid=$id";
            $result = $database->query($sqlmain);
            $row = $result->fetch_assoc();
            $archiname = $row["archiname"];
            $scheduleid = $row["scheduleid"];
            ...
            $sqlmain12 = "select * from appointment inner join client on client.client_id=appointment.client_id inner join schedule on schedule.scheduleid=appointment.scheduleid where schedule.scheduleid=$id;";
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-archi-form-container" border="0">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="Email" class="form-label">Architect of this session: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="Email" class="form-label">Total Cost: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                                ' . number_format($cost, 2) . '<br><br>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
